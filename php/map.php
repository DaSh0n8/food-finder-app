...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <main class="mdl-layout__content">
        ...
        <div class="main-left">
            ...
            <div id="menu">
                <input id="osm-carto" type="radio" name="rtoggle" value="osm-carto" checked="checked">
                ...
                <label for="klokantech-basic"><img src="../images/klokantech-basic.png" alt="klokantech-basic"
                                                   style="max-width: 70px; max-height: 70px;" onclick="changeMapStyle('klokantech-basic')"></label>
                <input id="osm-liberty" type="radio" name="rtoggle" value="osm-liberty">
                ...
                <input id="toner-grey" type="radio" name="rtoggle" value="satellite-streets">
                ...
                <input id="positron-blue" type="radio" name="rtoggle" value="positron-blue">
                <label for="positron-blue"><img src="../images/positron-blue.png" alt="positron-blue"
                                                style="max-width: 70px; max-height: 70px;" onclick="changeMapStyle('positron-blue')"></label>
                <input id="dark-matter-dark-grey" type="radio" name="rtoggle" value="dark-matter-dark-grey">
                <label for="dark-matter-dark-grey"><img src="../images/dark-matter-dark-grey.png" alt="dark-matter-dark-grey"
                                                        style="max-width: 70px; max-height: 70px;" onclick="changeMapStyle('dark-matter-dark-grey')"></label>
            </div>
            <div class="bottom">
                <div class="mdl-grid">
                    <div id="buttons">
